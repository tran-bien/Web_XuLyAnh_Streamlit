...
st.write("## Nhận dạng 5 loại Đối tượng Trái cây")
...
try:
    ...
    st.session_state["Net"] = cv2.dnn.readNet("D:\\Page_XuLyAnh_Streamlit_21110140_21110301\\Page_streamlit_21110140_21110301\\NhanDang5DoiTuong_yolov8\\yolov8n_trai_cay.onnx")
...
if img_file_buffer is not None:
    ...
    with col1:
        st.image(image, caption='Trai_Cay', use_column_width=True)
    ...
    if st.button('Predict'):
        if frame is not None:
            ...
            with col2:
                st.image(pil_image, caption='Trai_Cay_Predict', use_column_width=True)
